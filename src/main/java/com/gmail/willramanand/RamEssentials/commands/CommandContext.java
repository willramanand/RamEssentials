...
public class CommandContext {
    ...
    public List<EssCommand> commandChain = new ArrayList<>();
    ...
    public CommandContext(CommandSender sender, Command command, List<String> args, String alias) {
        ...
        if (sender instanceof Player) {
            ...
            this.ePlayer = RamEssentials.getInstance().getPlayerManager().getPlayerData(player);
        }
    }
    ...
    // EPlayer args
    public EPlayer playerToEPlayer(Player player, EPlayer def) {
        if (player == null) {
            return def;
        }
    ...
    public EPlayer argAsEPlayer(int index, EPlayer def) {
        return playerToEPlayer(argAsPlayer(index), def);
    }

    public EPlayer argAsEPlayer(int index) {
        return argAsEPlayer(index, null);
    }
